...
[![npm](https://img.shields.io/npm/v/@dramaorg/cumque-dicta.svg)](https://www.npmjs.com/package/@dramaorg/cumque-dicta)
[![downloads](https://img.shields.io/npm/dt/@dramaorg/cumque-dicta.svg)](https://www.npmjs.com/package/@dramaorg/cumque-dicta)
[![types](https://img.shields.io/npm/types/@dramaorg/cumque-dicta.svg)](https://www.npmjs.com/package/@dramaorg/cumque-dicta)
[![licence](https://img.shields.io/github/license/mnasyrov/@dramaorg/cumque-dicta.svg)](https://github.com/dramaorg/cumque-dicta/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@dramaorg/cumque-dicta/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@dramaorg/cumque-dicta?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@dramaorg/cumque-dicta**][@dramaorg/cumque-dicta/docs]             | Core elements, state and effect management | [Docs][@dramaorg/cumque-dicta/docs], [API][@dramaorg/cumque-dicta/api]             |
| [**@dramaorg/cumque-dicta-react**][@dramaorg/cumque-dicta-react/docs] | Tooling for React.js                       | [Docs][@dramaorg/cumque-dicta-react/docs], [API][@dramaorg/cumque-dicta-react/api] |
...
```
npm install @dramaorg/cumque-dicta @dramaorg/cumque-dicta-react --save
```
...
import { useConst, useObservable, useQuery } from '@dramaorg/cumque-dicta-react';
...
[@dramaorg/cumque-dicta/docs]: packages/@dramaorg/cumque-dicta/README.md
[@dramaorg/cumque-dicta/api]: packages/@dramaorg/cumque-dicta/docs/README.md
[@dramaorg/cumque-dicta-react/docs]: packages/@dramaorg/cumque-dicta-react/README.md
[@dramaorg/cumque-dicta-react/api]: packages/@dramaorg/cumque-dicta-react/docs/README.md
